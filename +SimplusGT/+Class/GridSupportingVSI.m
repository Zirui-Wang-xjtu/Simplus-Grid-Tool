% This class defines the model of a grid-Supporting voltage source inverter.

% Author(s): Yitong Li
%
% Modified by: Zirui Wang
...
classdef GridSupportingVSI < SimplusGT.Class.ModelAdvance
    ...
    methods
        % constructor
        function obj = GridSupportingVSI(varargin)
